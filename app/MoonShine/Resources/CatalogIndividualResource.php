...
/**
 * @extends ModelResource<CatalogIndividual>
 */
class CatalogIndividualResource extends ModelResource
{

    protected string $title = 'Физические лица';

    protected string $model = CatalogIndividual::class;
