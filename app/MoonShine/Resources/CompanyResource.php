...
class CompanyResource extends ModelResource
{
    ...
    protected string $title = 'Страховые компании';
                    ...
                    Tab::make(__('Общие настройки'), [
                        Grid::make([
                            Column::make([
                                ...
                                Image::make(__('Изображение'), 'img')
                                    ...
                                    ->removable(),
                                Text::make(__('Сокращенный заголовок'), 'title_mini'),
                                Textarea::make(__('Подзаголовок'), 'subtitle'),
                        ...
                        Grid::make([
                            ...
                            Column::make([
                                ...
                                Json::make('Предложения от наших партнеров', 'options')->fields([

                                    Text::make('', 'option_title')->hint('Заголовок'),

                                                Json::make('Опции', 'options_json')->fields([

                                                Text::make('', 'option_label')->hint('Название опции'),
                                                Text::make('', 'option_text')->hint('Цена без валюты! Только цифры'),
