document.addEventListener('DOMContentLoaded', function () {
    !function (t) {
            ...
            fit: {
                ...
                left: function (t, e) {
                    ...
                    var i = e.within, s = i.offset.top + i.scrollTop, n = i.height,
                        i = i.isWindow ? i.scrollTop : i.offset.top, o = t.top - e.collisionPosition.marginTop,
                        a = o - i, o = o + e.collisionHeight - n - i,
        ...
        var W, u = V, d = {}, F = d.toString, L = /^([\-+])=\s*(\d+\.?\d*)/, R = [{
            ...
            }, Y = {byte: {floor: !0, max: 255}, percent: {max: 1}, degrees: {mod: 360, floor: !0}}, B = p.support = {},
            t = u("<p>")[0], g = u.each;
        ...
        V.effects = {effect: {}}, X = ["add", "remove", "toggle"], $ = {
            border: 1,
            borderBottom: 1,
            borderColor: 1,
            borderLeft: 1,
            ...
            addClass: (U = V.fn.addClass, function (t, e, i, s) {
                return e ? V.effects.animateClass.call(this, {add: t}, e, i, s) : U.apply(this, arguments)
            }), removeClass: (K = V.fn.removeClass, function (t, e, i, s) {
                return 1 < arguments.length ? V.effects.animateClass.call(this, {remove: t}, e, i, s) : K.apply(this, arguments)
            }), toggleClass: (q = V.fn.toggleClass, function (t, e, i, s, n) {
                return "boolean" == typeof e || void 0 === e ? i ? V.effects.animateClass.call(this, e ? {add: t} : {remove: t}, i, s, n) : q.apply(this, arguments) : V.effects.animateClass.call(this, {toggle: t}, e, i, s)
            ...
            effect: function () {
                ...
                var s = P.apply(this, arguments), n = V.effects.effect[s.effect], o = n.mode, e = s.queue,
                    i = e || "fx", a = s.complete, r = s.mode, l = [];
                ...
                var i = V(this), s = V(t.to), n = "fixed" === s.css("position"), o = V("body"),
                    a = n ? o.scrollTop() : 0, o = n ? o.scrollLeft() : 0, r = s.offset(),
        ...
        V.effects.define("blind", "hide", function (t, e) {
            ...
            var i, s, n = V(this), o = t.mode, a = "hide" === o, o = "show" === o, r = t.direction || "up",
                l = t.distance, h = t.times || 5, c = 2 * h + (o || a ? 1 : 0), u = t.duration / c, d = t.easing,
            ...
            var i, s, n, o, a, r, l = t.pieces ? Math.round(Math.sqrt(t.pieces)) : 3, h = l, c = V(this),
                u = "show" === t.mode, d = c.show().css("visibility", "hidden").offset(),
            ...
            var n, i = V(this), t = ["fontSize"],
                ...
                a = ["borderLeftWidth", "borderRightWidth", "paddingLeft", "paddingRight"], r = s.mode,
                l = "effect" !== r, h = s.scale || "both", c = s.origin || ["middle", "center"], u = i.css("position"),
                d = i.position(), p = V.effects.scaledDimensions(i), f = s.from || p,
            ...
            var i, s, n = V(this),
                ...
                h = "up" === r || "left" === r, c = t.distance || n["top" == l ? "outerHeight" : "outerWidth"](!0),
                u = {};
        ...
        V.ui.focusable, V.fn._form = function () {
            ...
            _eventHandler: function (t) {
                var e = this.options, i = this.active, s = V(t.currentTarget), n = s[0] === i[0],
                    o = n && e.collapsible, a = o ? V() : s.next(), r = i.next(),
        ...
        V.widget("ui.controlgroup", {
            ...
            return t ? this.length || "instance" !== i ? this.each(function () {
                ...
                var t = V(this).attr("type"), t = "checkbox" !== t && "radio" !== t ? "button" : "checkboxradio",
                    e = V.data(this, "ui-" + t);
                e ? (e.option(i || {}), e._init && e._init()) : "button" == t ? ot.call(V(this), i) : V(this).checkboxradio(V.extend({icon: !1}, i))
            })), n
        ...
        V.extend(V.ui, {datepicker: {version: "1.13.3"}}), V.extend(rt.prototype, {
            ...
            _generateHTML: function (t) {
                var e, i, s, n, o, E, W, F, L, a, r, R, l, h, c, u, d, p, f, g, m, _, Y, v, b, B, y, j, q, w, x, k,
                    ...
                    D = this._get(t, "isRTL"), C = this._get(t, "showButtonPanel"),
                    I = this._get(t, "hideIfNoPrevNext"), T = this._get(t, "navigationAsDateFormat"),
                    P = this._getNumberOfMonths(t), M = this._get(t, "showCurrentAtPos"),
                    S = this._get(t, "stepMonths"), U = 1 !== P[0] || 1 !== P[1],
        ...
        V(document).on("mouseup", function () {
            ...
            resize: function () {
                var t, e = V(this).resizable("instance"), i = e.options, s = e.size, n = e.originalSize,
                    ...
                    p = i.maxWidth && i.maxWidth < u, f = i.maxHeight && i.maxHeight < d,
                    g = i.minWidth && i.minWidth > u, m = i.minHeight && i.minHeight > d;
        ...
        V.ui.droppable, V.widget("ui.progressbar", {
            ...
            _refreshValue: function () {
                var e, i, t, s, n, o = this.options.range, a = this.options, r = this,
                    l = !this._animateOff && a.animate, h = {};
