    ...
    <div class="calc_row">
        <div class="calc_row__flex w_100">
            ...
            <div class="calc_col w_50 pad_l16">
                <x-forms.text-label name="{{__('Выбрать профессию')}}" class=""/>

                <div class="text_input">

                    <select class="js-chosen" name="profession"
                            placeholder="Выберете профессию">
                        <optgroup label="Выбрать профессию">

                            @foreach($calc['json_profession'] as $k =>$item)
                                <option value="{{$item['json_profession_text']}}">{{$item['json_profession_label']}}</option>
                            @endforeach
    ...
    <div class="calc_row realy_button">
        <div class="calc_row__flex w_100 pad_t16 pad_b16">
            ...
            <div class="realy_button__right calc_row w_50 pad_l16">
                <div class="text_input">
                    <input type="hidden" value="calcResponsibility" name="calcname">
